from fastapi import FastAPI,Body,Form,UploadFile,File,Query,Path
...
@app.post("/recomand",response_model=ResUser)
...
def get_path(age:int=Path(ge=10,le=100),name:str=Path(min_length=3,max_length=10,regex="^[A-Za-z]")):
    for val in dic:
